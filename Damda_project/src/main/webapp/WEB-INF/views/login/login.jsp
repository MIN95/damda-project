...
<head>
   ...
   padding: 0px;
    ...
    //크기줄였을 때 바뀌는 회원가입버튼
   $('#joinBtnHidden').on('click',function(){
      window.location.href="/login/join"
   });
    ...
    function resized2() {
         ...
         $("#joinBtnHidden").css('display','inline-block');
             $("#loginWrap").attr('class','col-md-offset-4 col-sm-offset-3 col-xs-offset-1 col-md-4 col-sm-6 col-xs-10');
         $("#saveIdCheck").css('font-size','12.5px'); 
         }else{
           $("#joinBtnHidden").css('display','none');
                ...
                <div id="edge01" class="col-md-12 col-sm-12 col-xs-12 outline">
                   ...
                   <form id="login" action="loginErr" method="post">
                     ...
                     <div id="loginBtnSection" class="form-group"> 
                        ...
                        <button id="joinBtnHidden" type="button" class="btn btn-default" style="display: none">회원가입</button>
                     </div>
                     <div id="saveIdCheck" class="col-md-12 col-sm-12 col-xs-12 text-center">
                  ...
                  <!-- 비회원 배송조회 ---------------------------------------->
                        ...
                        <div id="orderHistoryWrap" class="col-md-offset-4 col-sm-offset-3 col-xs-offset-2 col-md-4 col-sm-6 col-xs-8">
                            <form id="orderHistory" class="form-horizontal" method="POST" action="/login/nouserchk">
                                <div class="form-group">
                                    <label for="orderer" class="col-sm-4 control-label">주문자명</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="nousername" name="nousername">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div id="failnouserchk" style="display:none;">${failnouserchk }</div>
                            </form>
                        </div>
                        <!-- 비회원 구매 ---------------------------------------->
