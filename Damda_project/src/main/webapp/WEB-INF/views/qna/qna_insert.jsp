...
<form id="qnaForm" method="post" enctype="multipart/form-data" style="padding:0px;margin:0px;">
    ...
    <div class="row">  
    	<div class="col-md-offset-1 col-md-10">
			...
			<div id="qnaTab" class="col-md-12 col-sm-12 col-xs-12">
				<br /><br />
				<input type="hidden" id="m_userNum" name="m_userNum" value=${m_userNum } /> 
				...
				<thead>	
					<tr>
						...
						<th class="col-md-10 col-sm-10 col-xs-9">
							<input type="text" id="qnaSub" name="qnaSub" placeholder="제목을 입력해주세요" style="background-color: #eee">
						</th>
					</tr>
					<tr> 
						<th style="text-align: center;">Writer</th>
						<th><input type="text" id="m_userId" name="m_userId" value="${m_userId }" readonly="readonly" style="cursor:default;"></th>
					</tr>
					<tr>
				...
				<tbody>
					<tr>
						<td colspan="2" class="col-md-12 text-left">
						 <textarea id="qnaCon" name="qnaCon" class="form-control col-md-12 col-sm-12 col-xs-12" rows="15" style="resize: none;" placeholder="내용을 입력해 주세요"  style="background-color: #eee"></textarea>
						 <ul id="qnaNotice">
					...
					<tr>
						...
						<th id="fileAdd">
							<button type="button" id="UploadBtn" class="glyphicon fa fa-upload btn" style="float: right;color:#fff;"></button>
						</th>
					</tr>
					<tr>
					...
					<tr>
						...
						<th><input type="text" id="qnaPw" name="qnaPw" placeholder="비밀번호를 입력하세요"  style="background-color: #eee"></th>
					</tr>
					<tr>
   ...
   <div class="modal" id="confirmModal" style="display: none; z-index: 1050;">
	...
	$(document).ready(function(){
		resized2();
		$('#qnaSub').focus();
		$("#m_userId").css("background-color","#eee");
    ...
    $("#UploadBtn").on('click',function(){
    	limit = $('.fileDelBtn').length;
       	if(limit<3){
        	$('#fileAdd').append('<input type="file" id="fileInput'+idx+'" class="fileCnt" name="qnaFile'+idx+'" style="display:none" />');          
