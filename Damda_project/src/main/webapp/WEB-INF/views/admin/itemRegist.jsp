   ...
   <div class="container-fluid text-center">
      <div class="row">
         ...
         <div id="registerTab" class="col-md-12 col-sm-12 col-xs-12">
            ...
            <tr>
				<th colspan="3" class="text-center"><br />
					<div id="uploadWrap" style="margin:0 auto">
                    	<div id="defaultFile" class="form-group select" style="padding:0px">     
<!--                         <input class="fileInput" id="photoOrder_0" name="photoOrder_0" type="file" style="margin-left:48px;width:50%;display:inline-block"> -->
<!--                      <button type="button" class="delBtn" id="photoDeleteBtn_0" style="display:inline-block;color:darksalmon">x</button>          -->
   ...
   var uploadOrder = 0;
     $("#uploadWrap button:first").on('click', function(){
      ...
      if(fileCount<5){    
         ...
         //상세-썸네일 띄울곳 append 
          var source2 = '<img id="photoAddAppend_'+uploadOrder+'" class="detailAppend form-group" alt="detail" src="" style="display:none;width:100%;padding:0px;margin:0 auto">';
