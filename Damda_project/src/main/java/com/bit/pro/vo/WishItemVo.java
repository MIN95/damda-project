...
public class WishItemVo {
	private int wishNum;
	private int w_userNum;
	private int w_itemNum;
	...
	public int getW_userNum() {
		return w_userNum;
	}

	public void setW_userNum(int w_userNum) {
		this.w_userNum = w_userNum;
	}

	public int getW_itemNum() {
		return w_itemNum;
	}

	public void setW_itemNum(int w_itemNum) {
		this.w_itemNum = w_itemNum;
	}
	...
	public int hashCode() {
		...
		result = prime * result + w_itemNum;
		result = prime * result + w_userNum;
		result = prime * result + wishNum;
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		WishItemVo other = (WishItemVo) obj;
		...
		if (startpoint != other.startpoint)
			return false;
		if (w_itemNum != other.w_itemNum)
			return false;
		if (w_userNum != other.w_userNum)
			return false;
		if (wishNum != other.wishNum)
			return false;
		return true;
	}
