...
public class PhotoVo {
	...
	public void setExistPhotoName(String existPhotoName) {
		this.existPhotoName = existPhotoName;
	}

	public int getExistPhotoLength() {
		return existPhotoLength;
	}

	public void setExistPhotoLength(int existPhotoLength) {
